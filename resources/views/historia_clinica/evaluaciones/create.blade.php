<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            Nueva Evaluación - Historia Clínica #{{ $his_id }}
        </h2>
    </x-slot>
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center">
                    ...
                    <h4 class="text-lg font-semibold text-gray-800">Registrar Nueva Evaluación</h4>
                </div>
            </div>

            <form method="POST" action="{{ route('evaluaciones.store', $his_id) }}" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('eva_evaluacion_dolor') }}"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div class="flex items-center">
                            <span id="dolor-badge" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 mr-3">
                                <span id="dolor-valor">{{ old('eva_escala_dolor', 0) }}</span>/10
                            </span>
                            <div class="flex space-x-1" id="dolor-circles">
                                @for ($i = 1; $i <= 10; $i++)
                                    <div class="w-3 h-3 rounded-full {{ $i <= old('eva_escala_dolor', 0) ? 'bg-red-400' : 'bg-gray-200' }}" data-nivel="{{ $i }}"></div>
                                @endfor
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="eva_examenes_complementarios"
                              ...
                              placeholder="Describa los exámenes complementarios realizados o requeridos...">{{ old('eva_examenes_complementarios') }}</textarea>
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                    ...
                    <a href="{{ route('evaluaciones.index', $his_id) }}"

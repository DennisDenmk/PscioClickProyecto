                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Paciente</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Cédula</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-600 bg-white dark:bg-gray-800">
                            @foreach ($historias as $historia)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $historia->his_id }}</td>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">
                                        {{ $historia->paciente->pac_nombres }} {{ $historia->paciente->pac_apellidos }}
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $historia->paciente->pac_cedula }}</td>
                                    <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $historia->created_at->format('d/m/Y') }}</td>
                                    <td class="px-4 py-3">

...
<head>
    ...
    <style>
        ...
        @keyframes color-wave {
            ...
            0%,
            100% {
                background: linear-gradient(45deg, #2d6a4f, #0f4c75);
            }

            33% {
                background: linear-gradient(45deg, #0f4c75, #00d4aa);
            }

            66% {
                background: linear-gradient(45deg, #00d4aa, #2d6a4f);
            }
        }
        ...
        .animate-floating-shapes {
            animation: floating-shapes 12s ease-in-out infinite;
        }
...
<body class="bg-white overflow-x-hidden">
    ...
    <div class="fixed inset-0 pointer-events-none z-0">
        <div class="floating-element w-64 h-64 bg-gradient-to-br from-primary to-accent top-10 left-10"
            style="animation-delay: 0s;"></div>
        <div class="floating-element w-32 h-32 bg-gradient-to-br from-accent to-accent-pink top-1/2 right-20"
            style="animation-delay: 2s;"></div>
        <div class="floating-element w-48 h-48 bg-gradient-to-br from-teal to-primary bottom-20 left-1/4"
            style="animation-delay: 4s;"></div>
        <div class="floating-element w-20 h-20 bg-gradient-to-br from-accent-pink to-accent top-1/4 right-1/3"
            style="animation-delay: 6s;"></div>
    </div>

    <!-- HEADER -->
    <header
        class="bg-white/80 backdrop-blur-xl shadow-lg border-b border-gray-200 sticky top-0 z-50 transition-all duration-300 rounded-b-3xl">
        <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
            ...
            <!-- BOTÓN SISTEMA -->
            <a href="{{ route('login') }}"
                class="hidden sm:flex items-center gap-2 px-5 py-2 rounded-full bg-primarycolor-logo text-white font-semibold shadow-md hover:shadow-xl transition hover:scale-105">
            ...
            <button onclick="toggleMobileMenu()"
                class="lg:hidden p-2 rounded-full hover:bg-gray-100 transition shadow-sm">
        ...
        <div id="mobile-menu"
            class="lg:hidden max-h-0 overflow-hidden transition-all duration-500 bg-white/90 backdrop-blur-xl border-t border-gray-200 shadow-lg rounded-b-2xl">
            <div class="px-6 py-8 flex flex-col items-center space-y-5 text-center">

                <!-- Menú Items -->
                <a href="#inicio"
                    class="flex items-center gap-3 text-gray-800 hover:text-primary font-medium text-lg transition-transform hover:translate-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 9.75L12 4l9 5.75M4.5 10.5v8.25h15V10.5" />
                    </svg>
                    Inicio
                </a>
                <a href="#servicios"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8.25 4.5h7.5m-9 3h10.5M12 12v7.5m4.5-3.75H7.5" />
                    </svg>
                    Servicios
                </a>
                <a href="#nosotros"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17.25 6.75A2.25 2.25 0 0119.5 9v6a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 15V9a2.25 2.25 0 012.25-2.25h10.5z" />
                    </svg>
                    Nosotros
                </a>
                <a href="#contacto"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M2.25 6.75L12 13.5l9.75-6.75M2.25 6.75v10.5a2.25 2.25 0 002.25 2.25h15a2.25 2.25 0 002.25-2.25V6.75" />
                    </svg>
                    Contacto
                </a>
                ...
                <!-- Botón sistema -->
                <a href="{{ route('login') }}"
                    class="mt-6 w-full max-w-xs px-6 py-3 rounded-full bg-primarycolor-logo text-white font-bold shadow-lg hover:shadow-xl transition hover:scale-105 flex items-center justify-center gap-2">
    ...
    <section id="inicio" class="relative overflow-hidden min-h-screen flex items-center justify-center py-24">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
            style="background-image: url('https://centromedicoporsalud.com/wp-content/uploads/2024/12/esp-terapia-y-rehabilitacion.jpg');">
            <div
                class="absolute inset-0 bg-gradient-to-r from-primary/90 via-teal/80 to-accent/90 animate-gradient-shift">
            </div>
        </div>

        <!-- Floating Shapes -->
        <div
            class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-green-400 to-accent rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-floating-shapes">
        </div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-teal to-pink-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-floating-shapes"
        ...
        <div class="relative z-10 max-w-6xl px-6 text-white text-center">
            <div class="space-y-6 section-reveal">
                <span
                    class="inline-block bg-white/20 backdrop-blur-sm px-5 py-2 rounded-full text-sm font-semibold animate-bounce-in tracking-wide">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 pt-6">
                    <a href="#contacto"
                        class="bg-white text-primary px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition hover:scale-105 btn-magnetic group">
                        <span class="group-hover:scale-110 transition-transform duration-300 inline-block">📞 Solicitar
                            Servicio</span>
                    </a>
                    <a href="#nosotros"
                        class="border-2 border-white text-white px-8 py-4 rounded-full font-semibold backdrop-blur-sm hover:scale-105 transition btn-magnetic group">
                        <span class="group-hover:scale-110 transition-transform duration-300 inline-block">📋 Conocer
                            Más</span>
                    </a>
                </div>
            </div>
    ...
    <section id="servicios" class="py-20 bg-gray-50 relative overflow-hidden">
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <!-- Fisioterapia -->
                <div
                    class="bg-white rounded-2xl p-8 shadow-lg card-hover section-reveal hover:-translate-y-1 hover:shadow-2xl transition duration-300">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mb-6 animate-pulse-glow">
                    ...
                    <ul class="text-gray-700 space-y-3 text-base">
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-primary to-accent rounded-full mr-3"></span><strong>Terapia
                                Física </strong> : Ejercicios específicos y seguimiento profesional.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-primary to-accent rounded-full mr-3"></span><strong>Masaje
                                Terapéutico </strong> : Alivio del dolor y relajación muscular.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-primary to-accent rounded-full mr-3"></span><strong>Rehabilitación
                                Geriátrica</strong> : Cuidado integral para adultos mayores.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-primary to-accent rounded-full mr-3"></span><strong>Valoración
                                Funcional</strong> : Diagnóstico para planes efectivos.</li>
                    </ul>
                </div>
                ...
                <div
                    class="bg-white rounded-2xl p-8 shadow-lg card-hover section-reveal hover:-translate-y-1 hover:shadow-2xl transition duration-300">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-teal to-accent-pink rounded-full flex items-center justify-center mb-6 animate-pulse-glow">
                    ...
                    <ul class="text-gray-700 space-y-3 text-base">
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-teal to-accent-pink rounded-full mr-3"></span><strong>Signos
                                Vitales</strong> : Monitoreo preciso y constante.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-teal to-accent-pink rounded-full mr-3"></span><strong>Cuidados
                                Generales</strong> : Asistencia humana y cálida.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-teal to-accent-pink rounded-full mr-3"></span><strong>Medicamentos</strong>
                            : Administración segura y controlada.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-teal to-accent-pink rounded-full mr-3"></span><strong>Sueros
                                y Vitaminas</strong> : Rehidratación y energía al instante.</li>
                        <li class="flex items-center"><span
                                class="w-2 h-2 bg-gradient-to-r from-teal to-accent-pink rounded-full mr-3"></span><strong>Curación
                                de Heridas </strong> : Tratamientos limpios y eficaces.</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="section-reveal">
                    <p class="text-lg text-gray-600 mb-8">
                        En <strong>DayJu Life</strong> nos enfocamos en brindarte un servicio humano, profesional y
                        transformador.
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start group">
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mr-4 mt-1 group-hover:scale-125 transition-transform duration-300">
                                <span class="text-white text-sm">✓</span>
                            </div>
                            <div>
                                <h3
                                    class="text-xl font-semibold text-gray-800 mb-2 group-hover:text-primary transition-colors duration-300">
                                    Profesionales Certificados</h3>
                                <p class="text-gray-600">Fisioterapeutas y enfermeras con experiencia y formación
                                    actualizada.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Planes diseñados específicamente para tus necesidades y tu
                                    recuperación.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Más de 600 pacientes han mejorado su calidad de vida junto a
                                    nosotros.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
                        <div class="relative overflow-hidden">
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-primary/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            </div>
                        </div>
                        <div class="p-6">
                            <h4
                            ...
                            <p class="text-gray-600 mb-3">
                                Sesiones especializadas para tu recuperación muscular, articular y postural con técnicas
                                modernas.
                            </p>
                            <div class="flex items-center text-sm text-gray-500">
                                <span
                                    class="bg-green-100 text-green-800 px-3 py-1 rounded-full font-medium">Fisioterapia</span>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
                        <div class="relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                                ...
                                class="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-110">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-accent/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            </div>
                        </div>
                        <div class="p-6">
                            <h4
                                class="text-xl font-semibold text-gray-800 mb-2 group-hover:text-primary transition-colors duration-300">
                                Cuidados de Enfermería</h4>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
                        <div class="relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                                ...
                                class="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-110">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-teal/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            </div>
                        </div>
                        <div class="p-6">
                            <h4
                                class="text-xl font-semibold text-gray-800 mb-2 group-hover:text-primary transition-colors duration-300">
                                Rehabilitación Geriátrica</h4>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover group">
                        <div class="relative overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                                ...
                                class="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-110">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-accent-pink/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            </div>
                        </div>
                        <div class="p-6">
                            <h4
                                class="text-xl font-semibold text-gray-800 mb-2 group-hover:text-primary transition-colors duration-300">
                                Masaje Terapéutico</h4>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg card-hover section-reveal">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center group">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="flex items-center group">
                            ...
                            <div>
                                <h4
                                    class="font-semibold text-gray-800 group-hover:text-primary transition-colors duration-300">
                                    Teléfono</h4>
                                <p class="text-gray-600">+593 99 910 9452</p>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg card-hover section-reveal">
                    ...
                    <form id="form-reserva" class="space-y-4">
                        ...
                        <button type="submit"
                            ...
                            <span class="group-hover:scale-110 transition-transform duration-300 inline-block">📱
    ...
    <footer class="bg-gray-800 text-white py-16 relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-4 gap-10">
                ...
                <div class="section-reveal space-y-4">
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center animate-pulse-glow mr-3">
                ...
                <div class="section-reveal">
                    ...
                    <ul class="space-y-2 text-gray-400 text-sm">
                        <li><a href="#inicio"
                                class="hover:text-accent transition-all duration-300 hover:translate-x-2 inline-block">Inicio</a>
                        </li>
                        <li><a href="#servicios"
                                class="hover:text-accent transition-all duration-300 hover:translate-x-2 inline-block">Servicios</a>
                        </li>
                        <li><a href="#nosotros"
                                class="hover:text-accent transition-all duration-300 hover:translate-x-2 inline-block">Nosotros</a>
                        </li>
                        <li><a href="#contacto"
                                class="hover:text-accent transition-all duration-300 hover:translate-x-2 inline-block">Contacto</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="section-reveal">
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/dayjulife1/reels/" target="_blank"
                            rel="noopener noreferrer"
                            class="w-10 h-10 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center hover:scale-125 transition-all duration-300 animate-pulse-glow group">
                            <span class="group-hover:rotate-12 transition-transform duration-300">f</span>
                        </a>

                        <a href="https://www.instagram.com/dayjulife/" target="_blank" rel="noopener noreferrer"
                            class="w-10 h-10 bg-gradient-to-br from-accent to-accent-pink rounded-full flex items-center justify-center hover:scale-125 transition-all duration-300 animate-pulse-glow group">
        ...
        <!-- Línea animada -->
        <div
            class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-accent to-accent-pink animate-gradient-shift">
        </div>
    </footer>

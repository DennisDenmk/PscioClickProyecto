        ...
        <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-lg shadow-md">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full uppercase" style="text-transform: uppercase;"
                        type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                </div>
                <div>
                    <x-input-label for="apellido" :value="__('Apellido')" />
                    <x-text-input id="apellido" class="block mt-1 w-full uppercase" style="text-transform: uppercase;"
                        type="text" name="apellido" :value="old('apellido')" required autofocus autocomplete="apellido" />
                </div>
                <!-- Cedula -->
                <div class="mt-4">
                    <x-input-label for="cedula" :value="__('Cédula')" />
                    <x-text-input id="cedula" class="block mt-1 w-full" type="text" name="cedula"
                        :value="old('cedula')" maxlength="10" required autocomplete="off" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="telefono" class="block mt-1 w-full" type="text" name="telefono"
                        :value="old('telefono')" maxlength="10" required autocomplete="off" />

        ...
        <div class="mb-8">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <a href="{{ route('historias.show', $historia->his_id) }}"
                   class="group relative bg-slate-800 hover:bg-slate-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    <span class="relative z-10">Consultas</span>
                    <div class="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                </a>
                ...
                <a href="{{ route('antecedentes.show', $historia->his_id) }}"
                   class="group relative bg-white hover:bg-emerald-50 text-emerald-700 hover:text-emerald-800 font-semibold py-3 px-4 rounded-lg border-2 border-emerald-300 hover:border-emerald-500 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    Antecedentes
                </a>
                
                <a href="{{ route('enfermedad_actual.index', $historia->his_id) }}"
                   class="group relative bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    Enfermedad Actual
                </a>
                
                <a href="{{ route('plan_tratamiento.index', $historia->his_id) }}"
                   class="group relative bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    Plan de Tratamiento
                </a>
                
                <a href="{{ route('estado_reproductivo.index', $historia->his_id) }}"
                   class="group relative bg-teal-700 hover:bg-teal-800 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    Estado Reproductivo
                </a>
                
                <a href="{{ route('evaluaciones.index', $historia->his_id) }}"
                   class="group relative bg-slate-700 hover:bg-slate-600 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                    Evaluaciones
                </a>
            </div>
        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    ...
                    <div class="p-6 space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-900 font-semibold">{{ $historia->paciente->pac_nombres ?? 'No disponible' }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="font-medium text-gray-600">Cédula:</span>
                            <span class="text-gray-900 font-semibold">{{ $historia->paciente->pac_cedula ?? 'No disponible' }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        @if ($ultimoAntecedente)
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    <span class="font-medium text-gray-600">Tipo:</span>
                                    <span class="text-gray-900 font-semibold">{{ $ultimoAntecedente->tipoAntecedente->tipo_ant_nombre ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium text-gray-600">Valor:</span>
                                    <span class="text-gray-900 font-semibold">{{ $ultimoAntecedente->ant_valor }}</span>
                                </div>
                                <div>
                                    <span class="font-medium text-gray-600">Detalle:</span>

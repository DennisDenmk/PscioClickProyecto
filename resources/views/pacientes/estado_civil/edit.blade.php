<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Editar Estado Civil</h2>
    </x-slot>
    ...
    <div class="py-6 max-w-xl mx-auto px-4">
        <form method="POST" action="{{ route('estado_civil.update', $estado->estc_id) }}"
            ...
            <div>
                ...
                <input type="text" name="estc_nombre" id="estc_nombre" value="{{ $estado->estc_nombre }}"

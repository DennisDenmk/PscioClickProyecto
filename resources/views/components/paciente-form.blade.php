...
<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        ...
        <select name="pac_sexo" class="form-select w-full" required>
            <option value="1" {{ old('pac_sexo', $paciente->pac_sexo ?? '') == 1 ? 'selected' : '' }}>Masculino
            </option>
            <option value="0" {{ old('pac_sexo', $paciente->pac_sexo ?? '') == 0 ? 'selected' : '' }}>Femenino
            </option>
        </select>
    </div>
    ...
    <div>
        ...
        <input type="text" name="pac_profesion" class="form-input w-full" required
            value="{{ old('pac_profesion', $paciente->pac_profesion ?? '') }}">
    </div>

    <div>
        <label class="block">Ocupación</label>
        <input type="text" name="pac_ocupacion" class="form-input w-full" required
    ...
    <div>
        ...
        <input type="text" name="pac_telefono" id="pac_telefono" maxlength="10" pattern="[0-9]{10}"
            ...
            class="form-input w-full" value="{{ old('pac_telefono', $paciente->pac_telefono ?? '') }}">
    </div>
    ...
    <div class="col-span-2">
        ...
        <input type="email" name="pac_email" class="form-input w-full" required
